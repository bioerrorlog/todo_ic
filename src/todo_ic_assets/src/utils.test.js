...
describe('convertArrayToObject', () => {
  ...
  test('convert with Xn item', () => {
    const input = [
      { id: 0n, description: 'This is description 0.' },
      { id: 1n, description: 'This is description 1.' },
      { id: 2n, description: 'This is description 2.' },
      { id: 3n, description: 'This is description 3.' },
    ];

    const output = {
      0: { id: 0n, description: 'This is description 0.' },
      1: { id: 1n, description: 'This is description 1.' },
      2: { id: 2n, description: 'This is description 2.' },
      3: { id: 3n, description: 'This is description 3.' },
    };
